...
import 'package:jahzha_app/views/shipment_details/view.dart';
...
class ShipmentCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () => RouteUtils.navigateTo(ShipmentDetailsView(
        id: shipment.id,
      )),
      child: Container(
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      AppText(
                        title: shipment.expectedArrivalTime,
                        fontSize: 14,
