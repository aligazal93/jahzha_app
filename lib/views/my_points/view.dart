          ...
          builder: (context, state) {
            ...
            return ListView(
              ...
              children: [
                ...
                myPointsData!.isEmpty ? NoDataFoundView() : Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    AppText(
                    ...
                    ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return MyPointsCard(
                          ...
                          createAt: Utils.formatDate(myPointsData[index].createdAt),
                          idNumber: myPointsData![index].type == "admin_gift" ? '0' :myPointsData[index].shipment!.shipmentNumber,
